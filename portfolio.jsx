    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#FAFAF8", color: "#1a1a1a", minHeight: "100vh" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .mobile-drawer .mob-link { font-family: 'Cormorant Garamond', serif; font-size: 1.9rem; font-style: italic; color: #1a1a1a; cursor: pointer; padding: 0.6rem 0; border-bottom: 1px solid #e8e8e2; transition: color 0.2s; display: block; }
