      ...
      <div ref={scrollRef} role="dialog" aria-modal="true" aria-label={`Case study: ${study.title}`} aria-describedby="panel-summary" style={{ position: "fixed", top: 0, right: 0, bottom: 0, width: "min(680px, 95vw)", background: "#FAFAF8", zIndex: 301, display: "flex", flexDirection: "column", boxShadow: "-12px 0 48px rgba(0,0,0,0.15)", animation: "slideInPanel 0.32s cubic-bezier(0.32,0,0.15,1) both", overflowY: "auto" }}>
        ...
        <div style={{ padding: "2rem 1.5rem 3rem", flex: 1 }}>
          ...
          <div style={{ marginBottom: "1.8rem" }}>
            ...
            <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "clamp(1.5rem, 3vw, 2rem)", lineHeight: 1.15, letterSpacing: "-0.015em", color: "#1a1a1a", marginBottom: "0.4rem" }}>{study.title}</h2>
          ...
          <div style={{ marginBottom: "2rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "0.6rem", marginBottom: "0.85rem" }}>
              ...
              <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.1rem", color: "#1a1a1a", fontStyle: "italic" }}>The Challenge</p>
            </div>
          ...
          <div style={{ marginBottom: "2rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "0.6rem", marginBottom: "1.1rem" }}>
              ...
              <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.1rem", color: "#1a1a1a", fontStyle: "italic" }}>My Approach</p>
            </div>
                ...
                {study.approach.map((step, i) => (
                  <div key={i} style={{ display: "flex", gap: "1rem", alignItems: "flex-start" }}>
                    ...
                    <div style={{ flex: 1, paddingBottom: i < study.approach.length - 1 ? "0.5rem" : 0 }}>
                      <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "0.93rem", color: step.color, marginBottom: "0.35rem" }}>{step.stage}</p>
          ...
          <div style={{ marginBottom: "2rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "0.6rem", marginBottom: "0.85rem" }}>
              ...
              <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.1rem", color: "#1a1a1a", fontStyle: "italic" }}>The Outcome</p>
            </div>
                ...
                {study.outcome.stat && (
                  <div style={{ marginBottom: "1.4rem" }}>
                    <div style={{ display: "inline-flex", alignItems: "center", gap: "1rem", background: "#2563EB10", border: "1.5px solid #2563EB30", borderRadius: 8, padding: "0.9rem 1.4rem" }}>
                      <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "2rem", color: "#2563EB", lineHeight: 1 }}>{study.outcome.stat.value}</p>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
                    {study.outcome.quotes.map((q, i) => (
                      <div key={i} style={{ borderLeft: "3px solid #2563EB44", paddingLeft: "1rem", paddingTop: "0.1rem", paddingBottom: "0.1rem" }}>
                        <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "0.93rem", fontStyle: "italic", color: "#333", lineHeight: 1.65, marginBottom: "0.3rem" }}>"{q.text}"</p>
          ...
          <div role="dialog" aria-modal="true" aria-label="Methodology details" style={{ position: "fixed", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "min(480px, 90vw)", background: "#FAFAF8", borderRadius: 12, padding: "2rem", zIndex: 403, boxShadow: "0 24px 64px rgba(0,0,0,0.2)" }}>
            <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: "1.2rem" }}>
              <div>
                ...
                <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.05rem", fontStyle: "italic", color: "#1a1a1a", display: "inline" }}>{study.outcome.stat.methodology.headline}</p>
              </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.5rem" }}>
              {study.outcome.stat.methodology.stats.map((s, i) => (
                <div key={i} style={{ background: "white", border: "1.5px solid #eeeee8", borderRadius: 6, padding: "0.7rem 0.9rem" }}>
                  ...
                  <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.1rem", color: "#2563EB" }}>{s.value}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <button type="button"
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: "flex", alignItems: "baseline", gap: "0.75rem", flexWrap: "wrap" }}>
                  <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.05rem", color: isOpen ? era.accentColor : "#1a1a1a", fontStyle: isOpen ? "italic" : "normal", transition: "color 0.25s, font-style 0.25s" }}>{era.era}</p>
    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#FAFAF8", color: "#1a1a1a", minHeight: "100vh" }}>
      ...
      <nav aria-label="Main navigation" style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 200, background: scrolled || mobileOpen ? "rgba(250,250,248,0.97)" : "transparent", backdropFilter: scrolled || mobileOpen ? "blur(14px)" : "none", borderBottom: scrolled ? "1px solid #e8e8e2" : "none", transition: "background 0.3s ease, border-color 0.3s ease", padding: "0 2rem" }}>
        <div style={{ maxWidth: 1080, margin: "0 auto", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          {/* Logo */}
          <button type="button" onClick={() => { window.scrollTo({ top: 0, behavior: "smooth" }); setMobileOpen(false); }} style={{ background: "none", border: "none", cursor: "pointer", fontFamily: "'DM Serif Display', serif", fontSize: "1.05rem", color: "#1a1a1a", zIndex: 201 }}>
            Jess Dams
          </button>
      ...
      <section style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 2rem", paddingTop: 64, paddingBottom: 100, position: "relative", overflow: "hidden" }}>
        ...
        <div className="hero-grid" style={{ maxWidth: 780, margin: "0 auto", width: "100%", display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
          ...
          <div style={{ animation: "fadeUp 0.9s ease 0.05s both", width: "100%" }}>
            ...
            <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "clamp(3rem, 6vw, 5.4rem)", lineHeight: 1.02, letterSpacing: "-0.025em", marginBottom: "1.5rem" }}>
        ...
        <div className="about-grid" style={{ maxWidth: 1080, margin: "0 auto", display: "flex", gap: "5rem", alignItems: "flex-start" }}>
          <div style={{ flex: 1 }}>
            <FadeIn>
              ...
              <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "clamp(2rem, 3.8vw, 3.1rem)", lineHeight: 1.1, letterSpacing: "-0.015em" }}>
            ...
            {[
              ...
              <FadeIn key={i} delay={0.08 * i}>
                <div className="stat-card" style={{ borderLeft: `4px solid ${s.color}` }}
                  ...
                  <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.85rem", color: s.color, lineHeight: 1 }}>{s.num}</p>
        ...
        <div style={{ maxWidth: 1080, margin: "0 auto", position: "relative" }}>
          <FadeIn>
            <div style={{ marginBottom: "4rem", textAlign: "center" }}>
              ...
              <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "clamp(2rem, 3.8vw, 3.1rem)", lineHeight: 1.1, letterSpacing: "-0.015em", textAlign: "center" }}>
                ...
                <div className="process-step" style={{ "--dot-color": step.color }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ marginBottom: "0.6rem" }}>
                      ...
                      <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.25rem", color: "#1a1a1a", lineHeight: 1.2 }}>{step.stage}</p>
                    </div>
                    ...
                    <div style={{ borderLeft: `3px solid ${step.color}`, paddingLeft: "0.85rem" }}>
                      <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "0.85rem", fontStyle: "italic", color: "#444", lineHeight: 1.65 }}>{step.principle}</p>
                    </div>
                  </div>
                </div>
              </FadeIn>
        ...
        <div style={{ maxWidth: 1080, margin: "0 auto", position: "relative" }}>
          ...
          <FadeIn delay={0.05}>
            <div style={{ marginBottom: "1.1rem", padding: "2.4rem 2.8rem", background: "linear-gradient(135deg, #2563EB08, #7C3AED0d)", border: "1.5px solid #2563EB22", borderRadius: 8, borderLeft: "5px solid #2563EB", position: "relative" }}>
              <div style={{ position: "absolute", top: "1.6rem", right: "2rem", fontFamily: "'DM Serif Display', serif", fontSize: "5rem", lineHeight: 1, color: "#2563EB", opacity: 0.12, userSelect: "none" }}>"</div>
              <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "clamp(1.05rem, 2vw, 1.25rem)", lineHeight: 1.7, color: "#222", fontStyle: "italic", maxWidth: 820, marginBottom: "1.4rem" }}>
          ...
          <div className="tcard-grid">
            {[TESTIMONIALS[0], TESTIMONIALS[2], TESTIMONIALS[3], TESTIMONIALS[4], TESTIMONIALS[5]].map((t, i) => (
              <FadeIn key={i} delay={0.08 * (i + 1)}>
                <div className="tcard">
                  ...
                  {/* Opening quote mark */}
                  <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "2.2rem", lineHeight: 1, color: t.color, opacity: 0.25, marginBottom: "-0.6rem", userSelect: "none" }}>"</p>
            ...
            <FadeIn delay={0.52}>
              <div className="tcard" style={{ background: "linear-gradient(140deg, #2563EB 0%, #7C3AED 52%, #0891B2 100%)", border: "none", justifyContent: "center", alignItems: "center", textAlign: "center", minHeight: 220 }}>
                ...
                <p style={{ fontFamily: "'DM Serif Display', serif", fontSize: "1.1rem", color: "white", lineHeight: 1.4, marginBottom: "0.5rem", fontStyle: "italic" }}>
      ...
      <section id="contact" aria-label="Contact" style={{ padding: "7rem 2rem", background: "white", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 640, margin: "0 auto", textAlign: "center", position: "relative" }}>
          <FadeIn>
            ...
            <h2 style={{ fontFamily: "'DM Serif Display', serif", fontSize: "clamp(2.2rem, 4.5vw, 3.6rem)", lineHeight: 1.06, letterSpacing: "-0.015em", marginBottom: "1.1rem" }}>
